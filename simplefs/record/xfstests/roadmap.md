...
（`record/xfstests/2026-07-16-final-xfstests.md`，2026-07-17 smoke 复核一致）。
各 NOTRUN 原因的完整 case 清单见 `record/xfstests/unimplemented-plan.md`，本文只定义执行顺序。
...
完整证据见 `record/xfstests/2026-07-19-phase2-journal-progress.md`。
...
完整证据见 `record/xfstests/2026-07-20-phase2-jbd2-progress.md`。
...
- Phase 2 验收完成，完整修复和环境证据见
  `record/xfstests/2026-07-20-phase2-jbd2-progress.md`。
