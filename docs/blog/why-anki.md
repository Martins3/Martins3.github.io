...
同样的，很多事情，用 ChatGPT 查询就代价太高了，因为切换了上下文，等 AI 返回结果的，
我都不知道我刚才想要做什么事情了。而且本来很容易的事情，现在还需要上网查一下，成本不知不觉的改变了。
...
## 3. 使用零散的时间来掌握新的技能
Rust / C++ 如果没有使用的项目，日常状态很难学会

利用 Anki ，我可以记住那些已经学会的，不然每一次回来，都是重新开始。

## 4. 持续的思考复杂的问题

在前 AI 时代，如果彻底理解了，基本上不会忘记:

现在配合 AI ，很多东西都很容易理解了，但是很快又忘记了，所以一定需要过一段时间来回忆一下。

在复习的时候，如果发现自己回忆的不太流畅，就继续写一些新的想法，然后比对一下。
