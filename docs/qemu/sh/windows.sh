...
"$qemu" $arg_img -m 16G -smp $(($(getconf _NPROCESSORS_ONLN) - 1)) $arg_qemu_mon --enable-kvm $arg_cpu $arg_monitor $arg_mem_balloon $arg_qmp $arg_virtio -display gtk $arg_win11 $arg_vfio $arg_usb
