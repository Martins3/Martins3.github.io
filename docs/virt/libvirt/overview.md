...
> 观察 libvirt 的代码，cmdDomMemStat 和 qemuMonitorJSONGetMemoryStats 中 VIR_DOMAIN_MEMORY_STAT_USABLE 这个宏的使用，
那么就是 avaliable 的含义了
...
https://documentation.suse.com/zh-cn/sles/15-SP3/html/SLES-all/cha-libvirt-config-virsh.html
