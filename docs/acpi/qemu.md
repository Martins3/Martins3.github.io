...
virt_acpi_setup 中:
- virt_acpi_build : 将 table 构建出来
- acpi_add_rom_blob : table 中的内容通过 rom 暴露出来

## rsdp 是什么东西
- https://lore.kernel.org/all/CAAiCvkiQS9L99Npzk5Ak0G67Fh3JiCbR50hBHR2Moz5Vz50gBA@mail.gmail.com/
