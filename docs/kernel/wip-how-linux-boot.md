## linux 如何启动
https://news.ycombinator.com/item?id=35598636

到时候把 initramfs ，bios , grub 之类的东西都搞进来
...
## 这个启动参数是什么意思
```txt
BOOT_IMAGE=(hd0,gpt2)/vmlinuz-6.17.9-200.fc42.aarch64 root=/dev/mapper/fedora-root ro rd.lvm.lv=fedora/root nokaslr console=ttyS1 earlyprink=serial mitigations=off selinux=0 audit=0
```
BOOT_IMAGE
