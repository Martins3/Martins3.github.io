# Enable dune (mips) with fpu
lazy mode 其实非常的麻烦, 默认是 eager mode, 为此 x86 添加专门的指令来处理 FPU save.[^1]

- [ ] 如何测试 ?

- loongson-dune/cross/arch/mips/include/asm/fpu.h:lose_fpu_inatomic
- in dune, process always has fpu enabed.
- loongson-dune/cross/arch/mips/kvm/callback.c 定义了保存 fpu, msa 和 lasx 相关的函数
