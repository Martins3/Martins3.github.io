...
xdr_filename3 (XDR *xdrs, filename3 *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_string (xdrs, objp, NFS3_MAXNAMLEN))
		 return FALSE;
	return TRUE;
}
...
xdr_READ3resok (XDR *xdrs, READ3resok *objp)
{
	register int32_t *buf;
	 ...
	 if (!xdr_bool (xdrs, &objp->eof))
		 return FALSE;
	 if (!xdr_bytes (xdrs, (char **)&objp->data.data_val, (u_int *) &objp->data.data_len, NFS3_MAXDATA))
		 return FALSE;
	return TRUE;
}
...
xdr_WRITE3resok (XDR *xdrs, WRITE3resok *objp)
{
	...
	int i;
	 ...
	 if (!xdr_stable_how (xdrs, &objp->committed))
		 return FALSE;
	 if (!xdr_opaque (xdrs, objp->verf, NFS3_WRITEVERFSIZE))
		 return FALSE;
	return TRUE;
}
...
xdr_set_mode3 (XDR *xdrs, set_mode3 *objp)
{
	...
	switch (objp->set_it) {
	case TRUE:
		 if (!xdr_uint32 (xdrs, &objp->set_mode3_u.mode))
			 return FALSE;
		break;
	case FALSE:
		break;
...
xdr_set_uid3 (XDR *xdrs, set_uid3 *objp)
{
	...
	switch (objp->set_it) {
	case TRUE:
		 if (!xdr_uint32 (xdrs, &objp->set_uid3_u.uid))
			 return FALSE;
		break;
	case FALSE:
		break;
...
xdr_set_gid3 (XDR *xdrs, set_gid3 *objp)
{
	...
	switch (objp->set_it) {
	case TRUE:
		 if (!xdr_uint32 (xdrs, &objp->set_gid3_u.gid))
			 return FALSE;
		break;
	case FALSE:
		break;
...
xdr_set_size3 (XDR *xdrs, set_size3 *objp)
{
	...
	switch (objp->set_it) {
	case TRUE:
		 if (!xdr_uint64 (xdrs, &objp->set_size3_u.size))
			 return FALSE;
		break;
	case FALSE:
		break;
...
bool_t
xdr_DUMMY3args (XDR *xdrs, DUMMY3args *objp)
{
	register int32_t *buf;
...
bool_t
xdr_DUMMY3res (XDR *xdrs, DUMMY3res *objp)
{
	register int32_t *buf;
