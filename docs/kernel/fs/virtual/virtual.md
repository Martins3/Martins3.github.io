## 总结一下各种虚拟文件系统
<!-- 753862a0-e1c1-43ec-8295-9f07b85e53c5 -->
...
- https://lwn.net/Articles/960088/
  - https://mp.weixin.qq.com/s?__biz=Mzg2MjE0NDE5OA==&mid=2247488246&idx=1&sn=c72076b410d7ee7e69614e4da868a3d8&chksm=cff1609006bac632a24531a0473dd0eb6aa7048ab991dd0b71fa8f92cef7b20211e7325ad64d&scene=132&exptype=timeline_recommend_article_extendread_samebiz&show_related_article=1&subscene=0&scene=132#wechat_redirect
  - https://lwn.net/Articles/938077/
...
## kernfs
到底谁在依赖 kernfs ，通过搜索 `select KERNFS` 可以找到
sysfs cgroup psi 是通过 kernfs 来构建的。

## 从这个看起
🧀  cat /proc/mounts | awk '{ print $3 }'
devtmpfs
devpts
tmpfs
proc
...
## TODO
1. 可以看看 shmem 的结果做各种文件系统测试的结果，会如何?
