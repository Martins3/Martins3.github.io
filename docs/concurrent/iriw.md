...
r1 = 1, r2 = 0, r3 = 1, r4 = 0? (Can Threads 3 and 4 see x and y change in
different orders?)
...
这是 memory model 中最后一个问题了，这里总是想不清楚如何控制 cache
的实现是如何做的， 但是先记住基本事情，就是 x86 的 cache 一致性让所有的 CPU
可以同时看到(也就是就像是到达 cache 后，是瞬间到达的所有的 CPU 的，没有传输时间)
