// TSan 能测到的典型场景: 两个线程对共享变量的 write-write data race
// (从 ../code/tools/drd.c 拷贝过来, 原文件还被 docs/concurrent/code/Makefile
// 的 drd/hel/tsan 目标使用, 所以保留原文件)
//
// TSan 基于 happens-before 关系判断 race, 不依赖时序恰好撞上,
// 所以即使结果"碰巧"等于 2000000, 也会报告 race.
#include <pthread.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
