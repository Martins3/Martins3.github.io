...
cmd="${debug_qemu} ${qemu} ${debug_kernel} ${arg_img} ${arg_mem} ${arg_cpu} ${arg_kernel} ${arg_seabios} ${arg_nvme} ${arg_nvme2} ${arg_iothread} ${arg_share_dir} ${arg_machine} ${arg_monitor} ${arg_tmp}"
echo "$cmd"
eval "$cmd"
